...
turn = 30;
% front fins
shoulder1 = [up down up]-20;
shoulder2 = [straight];
shoulder3 = [240 140 240];
shoulder4 = 180 + (180 - ([up_t down_t up_t] - 20) - turn);
shoulder5 = 180 + (180 - shoulder2);
shoulder2 = [200 160 200];
shoulder3 = [200 160 200];
shoulder6 = [120 220 120];
% back fins 
rear_yaw = 180;
rear_pitch = 180;
...
save('turnlf/dqd','dqd');
save('turnlf/ddqd','ddqd');
save('turnlf/tvec','tvec');
...
turn = 30;
% front fins
shoulder1 = [up_t down_t up_t]-20;
shoulder2 = [straight];
shoulder3 = [240 140 240];
shoulder4 = 180 + (180 - ([up down up]-20));
shoulder1 = shoulder1 + turn;
shoulder5 = 180 + (180 - [200 160 200]);
shoulder6 = [160 200 160];
...
save('turnrf/dqd.mat','dqd');
save('turnrf/ddqd.mat','ddqd');
save('turnrf/tvec.mat','tvec');
%% Dive Front Flippers
up = 210;
down = 150;
