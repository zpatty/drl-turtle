...
% shoulder7 = [180 180 180 180];
% shoulder8 = [180 180 180 180];
% shoulder9 = [180 170 120 180];
% shoulder10 = [180 200 270 180];
% % time points for a single cycle
% timePoints = [0 2 2.5 3.5];
% tshift = timePoints(2:end) + timePoints(2:end);
% timePoints_cycle = [timePoints, tshift(2:end)];
...
% dqd = dqd(:, 1:length(tvec));   
% ddqd = ddqd(:, 1:length(tvec));
% save('turnrr/qd.mat','qd');
% save('turnrr/dqd.mat','dqd');
% save('turnrr/ddqd.mat','ddqd');
% save('turnrr/tvec.mat','tvec');
...
% rear_yaw = 180;
% rear_pitch = 180;
% shoulder7 = [180 190 240 180];
% shoulder8 = [180 160 90 180];
% shoulder9 = [180 180 180 180];
% shoulder10 = [180 180 180 180];
% % time points for a single cycle
% timePoints = [0 2 2.5 3.5];
% tshift = timePoints(2:end) + timePoints(2:end);
% timePoints_cycle = [timePoints, tshift(2:end)];
...
% dqd = dqd(:, 1:length(tvec));   
% ddqd = ddqd(:, 1:length(tvec));
% save('turnlr/qd.mat','qd');
% save('turnlr/dqd.mat','dqd');
% save('turnlr/ddqd.mat','ddqd');
% save('turnlr/tvec.mat','tvec');