...
index = 0
# dxl_goal_position1 = [DXL_MINIMUM_POSITION_VALUE, DXL_MAXIMUM_POSITION_VALUE]        # Goal position
# dxl_goal_position2 = [DXL_MINIMUM_POSITION_VALUE, DXL_MAXIMUM_POSITION_VALUE]                                                        # Dynamixel LED value for write
